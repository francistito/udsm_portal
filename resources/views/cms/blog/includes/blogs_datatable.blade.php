...
<div class="row">
    ...
    <div class="col-md-4">
        <a href="{{route('cms.blog.create')}}" type="button" class="mb-1 mt-1 mr-1 btn btn-xs btn-primary pull-right">Create service</a>
    </div>
</div>
<div class="row">
    <div class="col-md-12">
...
@push('after-scripts')
    <script type="text/javascript">
        ...
        $('#blog-table').DataTable({
            ...
            columns: [
                // { data: 'DTRow_Index', name: 'DT_Row_Index', orderable: false, searchable: false},
