        ...
        <div class="row py-5 my-4">
            <div class="col-md-6 col-lg-4 mb-4 mb-lg-0"><h5 class="text-3 mb-3">NEWSLETTER</h5>
                ...
                <form id="newsletterForm"
                      action="https://preview.oklerthemes.com/porto/8.0.0/php/newsletter-subscribe.php"
                    ...
                    <div class="input-group input-group-rounded"><input
                            ...
                            class="input-group-append">										<button
                                class="btn btn-light text-color-dark" type="submit"><strong>GO!</strong></button>									</span>
                    </div>
                </form>
            </div>
                ...
                <div class="contact-details"><h5 class="text-3 mb-3">CONTACT US</h5>
                    <ul class="list list-icons list-icons-lg">
                        <li class="mb-1"><i class="far fa-dot-circle text-color-primary"></i>
                            <p class="m-0">234 Street Name, City Name</p></li>
        ...
        <div class="container py-2">
            <div class="row py-4">
                <div
                    ...
                    <a href="index-2.html" class="logo pr-0 pr-lg-3"> <img alt="Porto Website Template"
                                                                           src="img/logo-footer.png"
                                                                           class="opacity-5" height="33"> </a></div>
                <div
